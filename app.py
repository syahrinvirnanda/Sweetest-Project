...
app.config['UPLOAD_FOLDER'] = './static/profle_pics'
...
def home():
    ...
    try:
        ...
        msg = 'terdapat masalah ketika anda login'
        return redirect(url_for('login', msg=msg))
...
def sign_up():
    ...
    doc = {
        ...
        "profile_pic_real": "profile_pics/profile.jfif", # a default profile image
...
def update_profile():
    ...
    try:
        ...
        return jsonify({
            'result': 'success',
            'msg': 'profil anda sudah berhasil diperbarui'
        })
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for('home'))
